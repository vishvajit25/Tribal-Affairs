...
public class Maharashtra extends AppCompatActivity { //here state name should not have any space, follow caps (EG:TamilNadu)
    String[] type = {"Nuclear", "Joint"};
    Button create,next;
    Button map,about,search;
    String state = "Maharashtra"; //Here have space
...
//        String block2 = fblock.getText().toString().trim();
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ftaluk.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Maharashtra.this, "New Family Created", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), Maharashtra.class));
                    finish();
                }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Maharashtra.this, BasicDetails.class);
