...
public class Telangana extends AppCompatActivity { //here state name should not have any space, follow caps (EG:TamilNadu)
    String[] type = {"Nuclear", "Joint"};
    Button create,next;
    Button map,about,search;
    String state = "Telangana"; //Here have space
...
//        String block2 = fblock.getText().toString().trim();
        create.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (ftaluk.getText().toString().equals("")) {
                    ...
                    Toast.makeText(Telangana.this, "New Family Created", Toast.LENGTH_SHORT).show();
                    startActivity(new Intent(getApplicationContext(), Telangana.class));
                    finish();
                }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(Telangana.this, BasicDetails.class);
